...
void *f(void *arg)
{
    ...
    // it helps assuring that all threads finished the scaling
    ...
    // it helps assuring that all threads finished the modification
    pthread_barrier_wait(barrier);
...
int main(int argc, char *argv[])
{
    ...
    // the image does not need rescaling
    int ok = 0;
